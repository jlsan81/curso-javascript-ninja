...
desafio.
*/
var teams=['Flamengo','Botafogo','Vasco','Fluminense','Bangu'];
...
*/
function showTeamPosition(num1){


if (!!(teams[num1-1])){
return 'O time que está em '+num1+'º lugar é o '+teams[num1-1]+'.';
}
 
return'Não temos a informaçnao do time que está nessa posição.';
}   
...
case 'cinza':
console.log('O hexadecimal para a cor '+cor+' é #808080	#808080.');  
break;
