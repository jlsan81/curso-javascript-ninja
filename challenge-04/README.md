...
*/
var carro={marca:'idea',modelo:'elx',placa:'knu7g54',ano:2009,quantasPortas:4,cor:'verde',assentos:5,quantidadePessoas:0};
...
*/
carro.adicionarPassageiro=function(qtd){
    if (carro.assentos===0){
        return "O carro já está lotado!";
    }else if ((carro.assentos-qtd)<0){
        if (carro.assentos===4){
...
carro.retirarPassageiros=function(qtd){
    carro.assentos += qtd;
}

carro.retirarPassageiros(3);
